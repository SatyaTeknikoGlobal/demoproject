							...
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tbody>
										...
										<tr>
											<td style="padding: 30px 0px 0 40px;">
												...
												<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #626365; line-height: 32px; margin-bottom: 0; margin-top: 10px;">
													We are very thankful to you for showing your generosity for the welfare of visually impaired persons. Your kind support is a source of inspiration for us.

												</p>
											</td>
										</tr>
										<tr><td style="padding: 30px 0px 0 40px;">
												<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #626365; line-height: 32px; margin-bottom: 0; margin-top: 10px;">
													Your donation details is as under:
												</p>
										</td></tr>
										<tr>
											<td style="padding: 10px 0px 10px 40px;">
												<table>
													<tr>
														<th style="text-align: left;">Donation Amount: &nbsp;&nbsp;&nbsp;:&nbsp; </th> <td><?php echo $donation_amount; ?></td>
													</tr>
										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">						
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><p>Sincerely<br>Team Blind Welfare Society</p></p>
											</td>
										</tr>
