										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">
												<table>
													...
													<tr>
														<th style="text-align: left;">Date Of Booking :&nbsp; </th> <td><?php echo $date_of_booking; ?></td>
													</tr>
													<tr>
														<th style="text-align: left;">Type Of Meal :&nbsp; </th> <td><?php echo $type_of_meal; ?></td>
													</tr>
													<tr>
														<th style="text-align: left;">I Would Like To Book For :&nbsp; </th> <td><?php echo $book_for; ?></td>
													</tr>

													<tr>
														<th style="text-align: left;">Address :&nbsp; </th> <td><?php echo $address; ?></td>
													</tr>
													...
													?>
													<tr>
														<th style="text-align: left;">Transaction id :&nbsp; </th> <td><?php echo $transaction_id; ?></td>
													</tr>
													<?php } ?>
												</table>
											</td>
