...
<header class="header fullwidth"> 
	...
	//if(!empty($parentCategories) && count($parentCategories) > 0) {
		?>
		<div class="navicon "  data-toggle="collapse" aria-label="icons" data-target=".navbar-collapse"><span></span></div>
...
<li class="nav-item"><a href="{{url('mission-and-vision')}}">Mission and Vision</a></li>
<li class="nav-item"><a href="{{url('our-founder')}}">Our Founder</a></li>
<li class="nav-item"><a href="{{url('volunteer')}}">Volunteer</a></li>
<li class="nav-item droplinks">
<a href="#!" role="button" aria-expanded="true" tabindex="0" class="">Gallery</a>
...
<li class="nav-item"><a href="{{url('sponsor-a-meal')}}">Sponsor a Meal</a></li>
@if(CustomHelper::isAllowedModule('blogs'))
<li class="nav-item"><a href="{{url('blogs')}}">Blogs</a></li>
@endif
<li class="nav-item highlight-link"><a href="{{url('contact-us')}}">Contact Us</a></li>
