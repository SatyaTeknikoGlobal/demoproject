...
<header class="header fullwidth"> 
	...
	<div class="logo">
		<a href="{{url('/')}}" title="BWS Logo"><img src="{{$logoUrl}}" alt="BWS Logo" border="0" /></a>
	</div>
	...
	<div class="navbar-header pull-right ">
		<button type="button" class="navbar-toggle pz" data-toggle="collapse" aria-label="Menu Collapsed" data-target=".navbar-collapse">
	...
	<div class="navbar-collapse collapse" >
		<nav role="navigation" class="topmenu">
			<ul class="nav-menu js-nav-menu dekstop-menu-wrapper">
				<li class="nav-item" title="Home"><a id="skip_menu" href="{{url('/')}}">Home</a></li>
				...
				<a href="#!" role="button" aria-expanded="true" tabindex="0" class="gallery-menu-item ">Gallery</a>
				...
				<a href="#!" role="button" aria-expanded="false" tabindex="0" class="donate-menu-item">Donate</a>
				<div class="sub-nav" role="region" aria-expanded="false" aria-hidden="true">
				<ul class="sub-nav-group">
					<li title="Donate Online Within India"><a href="{{url('donate-online-within-india')}}">Donate Online Within India</a></li>
					<li title="International Donations"><a href="{{url('international-donations')}}">International Donations</a></li>
					<li title="Write a Cheque or DD"><a href="{{url('cheque-or-dd')}}">Write a Cheque or DD</a></li>
					<li title="Kind Donations"><a href="{{url('donate-for-a-kind')}}">Kind Donations</a></li>
				</ul>
				</div>
				</li>
				<li class="nav-item" title="Sponsor One-Time Meal"><a href="{{url('sponsor-a-meal')}}">Sponsor One-Time Meal</a></li>
			...
			<ul class="nav-menu js-nav-menu mobile-menu-wrapper">
				<li class="nav-item" title="Home"><a id="skip_menu" href="{{url('/')}}">Home</a></li>
				<li class="nav-item" title="About Us"><a href="{{url('about-us')}}">About Us</a></li>
				<li class="nav-item" title="Mission and Vision"><a href="{{url('mission-and-vision')}}">Mission and Vision</a></li>
				<li class="nav-item" title="Our Founder"><a href="{{url('our-founder')}}">Our Founder</a></li>
				<li class="nav-item" title="Volunteer"><a href="{{url('volunteer')}}">Volunteer</a></li>
				<li class="nav-item" title="Photo Gallery"><a href="{{url('gallery')}}">Photo Gallery</a></li>
				<li class="nav-item" title="Video Gallery"><a href="{{url('videos')}}">Video Gallery</a></li>
				<li class="nav-item" title="Donate"><a href="{{url('donate')}}">Donate</a></li>
				<!-- <li class="nav-item" title="Donate Online Within India"><a href="{{url('donate-online-within-india')}}">Donate Online Within India</a></li>
				<li class="nav-item" title="International Donations"><a href="{{url('international-donations')}}">International Donations</a></li>
				<li class="nav-item" title="Write a Cheque or DD"><a href="{{url('cheque-or-dd')}}">Write a Cheque or DD</a></li>
				<li class="nav-item" title="Kind Donations"><a href="{{url('donate-for-a-kind')}}">Kind Donations</a></li> -->
				<li class="nav-item" title="Sponsor One-Time Meal"><a href="{{url('sponsor-a-meal')}}">Sponsor One-Time Meal</a></li>
				@if(CustomHelper::isAllowedModule('blogs'))
				<li class="nav-item" title="Blogs"><a href="{{url('blogs')}}">Blogs</a></li>
				@endif
