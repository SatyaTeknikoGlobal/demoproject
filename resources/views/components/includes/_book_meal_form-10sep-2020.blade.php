...
<div class="msg"></div>
	...
	<ul class="formfild">
		...
		<li class="form-group">
			<label>Your Contact Number</label><sup>*</sup>
		...
		<li class="form-group">
			<label>Date Of Booking</label><sup>*</sup>
		...
		<li class="form-group">
			<label>I Would Like To Book For</label><sup>*</sup>
			<div class="radio-item">
				<label class="radio-inline">
