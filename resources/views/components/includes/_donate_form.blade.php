...
<div class="msg"></div>
	<ul class="formfild">
		<li class="form-group">
			<label for="donate">Select Donation <span title="This field is required.">*</span></label>
			<select id="donate" name="donation" class="donate" data-validation="required" required aria-required="true" onchange="showAmountBox(this.value)" >
		...
		<li class="form-group" id="amount_id" style="display:none">
			<label for="amount">Amount <span title="This field is required.">*</span></label>
			<input type="text" name="amount" id="amount"  placeholder="Amount" data-validation="required custom" data-validation-regexp="^([0-9]+)$" data-validation-error-msg-custom = "This should be numeric text" required aria-required="true"/>
		...
		<li class="form-group">
			<label for="address">Your Address <span title="This field is required.">*</span></label>
			<textarea name="address" id="address" placeholder="Address" data-validation="required" required aria-required="true"></textarea>
