...
<form method="POST" name="contactForm" onsubmit="return validate_contactform()">	
	<ul class="formfild">
		...
		<li>
			...
			<input type="text" name="name" id="name"  placeholder="Name" data-validation="required" aria-required="true"/>
		...
		<li>
			...
			<input type="email" name="contact_email" id="contact_email" placeholder="Email" data-validation="required" aria-required="true"/>
			<span class="error_c_email" style="color:red"></span>
		</li>
		<li>
			<label for="phone">Your Phone <span title="This field is required.">*</span></label>
			<input type="tel" name="phone" id="phone" placeholder="Phone" data-validation="required" aria-required="true" />
