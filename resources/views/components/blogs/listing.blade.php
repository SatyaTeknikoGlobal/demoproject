			...
			<li>
					...
					<div class="imgsec" style="background:#ccc url(<?php echo $image; ?>) center center no-repeat;">
						...
						<div class="contents">
							...
							<div class="content">
								<?php 
								echo CustomHelper::wordsLimit($blog->brief, $limit = 100, $isStripTags=false, $allowTags=''); ?>
							</div> 
							<a href="{{url('blogs/'.$blog->slug)}}"><div class="read-more">Read More <i class="arrow-icon"></i></div> </a>
						</div>
					</div>
